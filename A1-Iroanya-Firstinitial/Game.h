...
public:
	...
	void draw() {
		...
		string red = "Red (R - r) : " + std::to_string(color.r);
		string green = "Green (G - g): " + std::to_string(color.g);
		string blue = "Blue (B - b): " + std::to_string(color.b);
		string alpha = "Transparency (T - t): " + std::to_string(color.a);
		string sizeStr = "Size (+ -): " + std::to_string(size);
		string x = "X pos (a d): " + std::to_string(pos.x);
		string y = "Y pos (w s): " + std::to_string(pos.x);
		string speedStr = "Speed (i k): " + std::to_string(speed);
		string angleStr = "Angle (j l): " + std::to_string(angle);
		string shapeStr = "Shape (H h): " + std::to_string(shape);
